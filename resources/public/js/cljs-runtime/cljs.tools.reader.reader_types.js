...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_17489 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_17489(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_17491 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_17491(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17492 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17492(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17501 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17501(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17502 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17502(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17503 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17503(reader);
}
});
...
var G__17598 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__17599 = s.append(c);
c = G__17598;
s = G__17599;
continue;
}
