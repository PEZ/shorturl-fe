...
var i_17650 = (0);
while(true){
if((i_17650 < arr.length)){
(arr[i_17650] = null);

var G__17651 = (i_17650 + (1));
i_17650 = G__17651;
continue;
} else {
}
...
var i_17664 = (self__.level + (1));
while(true){
if((i_17664 <= (new_level + (1)))){
(update[i_17664] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17672 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17672[i]));
} else {
x__$2.forward.push((((i < links_17672.length))?(links_17672[i]):null));
}

if((i < links_17672.length)){
(links_17672[i] = x__$2);
} else {
links_17672.push(x__$2);
}
...
var i_17678 = (0);
while(true){
if((i_17678 <= self__.level)){
var links_17682 = (update[i_17678]).forward;
if((x__$1 === (((i_17678 < links_17682.length))?(links_17682[i_17678]):null))){
(links_17682[i_17678] = (x__$1.forward[i_17678]));

var G__17685 = (i_17678 + (1));
i_17678 = G__17685;
continue;
} else {
var G__17686 = (i_17678 + (1));
i_17678 = G__17686;
continue;
}
} else {
...
var G__17690 = nx;
var G__17691 = (level__$1 - (1));
x = G__17690;
level__$1 = G__17691;
continue;
} else {
var G__17692 = x;
var G__17693 = (level__$1 - (1));
x = G__17692;
level__$1 = G__17693;
continue;
}
